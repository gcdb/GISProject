...
\
10. Use Field Calculator to update mainland_joined\'s existing field NULL values to 0
![](images/paste-8C38A204.png)
...
![](images/paste-A5629B95.png)
7. Save Selected Features As walking into your Project GeoPackage
...
![](images/paste-98BB29A7.png)
3. Save Selected Features As privatedriving into your Project GeoPackage
...
a\. Buffer
The first method we will use to find the affected residentials of the closure of schools will be by using\
...
![](images/paste-CA847513.png)
![](images/paste-3146C658.png)
...
![](images/paste-487E0564.png)
1. Rename the temporary layer, Count, as\
...
![](images/paste-6375B0C2.png)
![](images/paste-2032F518.png)
...
At the end, the attribute table of 1km_affected should look like the following:
![](images/paste-0F767433.png)
